...
<<<<<<< HEAD
                <th style="text-align: left;color:#337ab7;" width="5%">Stt</th>
                <th style="text-align: center;color:#337ab7;" width="65%">Nhóm</th>
                <th style="text-align: left;color:#337ab7;" width="30%">Xóa</th>
=======
...
>>>>>>> origin/master
            ...
            foreach($result_group as $value_group){
                ...
                ?>
<<<<<<< HEAD
                    <td style="text-align: left;color:#337ab7;font-weight:bold;"><?= $stt; ?></td>
